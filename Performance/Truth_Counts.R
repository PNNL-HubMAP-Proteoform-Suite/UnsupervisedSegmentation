...
KCC <- calc_wrapper(1:10, "Kidney_Tiles/KCC_TXT", "_KCC.txt", "KCC")
fwrite(KCC, "~/Git_Repos/UnsupervisedSegmentation/Performance/DR_Counts/KCC_Counts.csv")
...
# pytorch-tip-------------------------------------------------------------------
Pytorch <- calc_wrapper_root(1:25, "Root/PyTorch_TXT", ".txt", "Pytorch", FALSE)
fwrite(Pytorch, "~/Git_Repos/UnsupervisedSegmentation/Performance/Root_Counts/PyTorch_Counts.csv", quote = F, row.names = F)

# Recolorize--------------------------------------------------------------------
Recolorize <- calc_wrapper_root(1:25, "Root/Recolorize_TXT", "_recolorize.txt", "Recolorize", FALSE)
fwrite(Recolorize, "~/Git_Repos/UnsupervisedSegmentation/Performance/Root_Counts/Recolorize_Counts.csv", quote = F, row.names = F)

# Supercells--------------------------------------------------------------------
Supercells <- calc_wrapper_root(1:25, "Root/Supercells_TXT", "_supercells.txt", "Supercells", FALSE)
